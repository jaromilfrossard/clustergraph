#' Plot of coefficients by effect, for multiple electrodes through time.
#'
#' @description Function to provide plot for exploratory analysis. Shows the effects (beta) through times for several electrodes.
#'
#' @param object a formula or clustergraph object
